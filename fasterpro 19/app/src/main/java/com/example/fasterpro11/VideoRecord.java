...
public class VideoRecord extends BroadcastReceiver {
        ...
        if (recorder != null) {
            try {
                ...
                if (e.getMessage().contains("stop failed")) {
                    Log.e(TAG, "Possible issue: Recorder may have been stopped previously.");
                }
            } catch (Exception e) {
                ...
                if (recorder != null) {
                    try {
                        ...
                        Log.e(TAG, "Error during recorder release: " + e.getMessage());
                    }
                }
            }
        } else {
    ...
    public void startVideoRecording(Context applicationContext) {
    }
}
