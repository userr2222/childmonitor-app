...
dependencies {
    ...
    //implementation ("com.sun.mail:javax.mail:1.6.5") // Adjust version as needed
    implementation ("io.socket:socket.io-client:2.0.0")  // Ensure this version or check for the latest version
