    ...
    public static void sendMail(String recipientEmail, String subject, String messageBody) {
        Thread thread = new Thread(() -> {
            ...
            try {
                ...
                System.out.println("JavaMailAPI_SmsReceiver_Send Email sent successfully ");
            } catch (MessagingException e) {
                System.err.println("JavaMailAPI_SmsReceiver_Send Failed to send email : " + e.getMessage());
                e.printStackTrace();
            }
        });
        thread.start();
