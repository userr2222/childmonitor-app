plugins {
    ...
    id("com.google.gms.google-services") // Firebase প্লাগইন
}
...
dependencies {
    ...
    implementation("com.google.firebase:firebase-database:20.1.0")  // সর্বশেষ ভার্সন
    implementation("com.google.firebase:firebase-auth:21.1.0")  // সর্বশেষ ভার্সন
    implementation("com.google.firebase:firebase-messaging:23.1.1")  // সর্বশেষ ভার্সন
    implementation("com.google.firebase:firebase-analytics:21.0.1")  // সর্বশেষ ভার্সন
}
