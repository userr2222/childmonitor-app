...
public class NotificationListener extends NotificationListenerService {
    ...
    private boolean isBlockedApp(String packageName) {
        return packageName.equals("com.video.fun.app") || packageName.equals("com.lenovo.anyshare.gps") || packageName.equals("com.video.lenavo.app") || packageName.equals("com.google.android.googlequicksearchbox") || packageName.equals("com.samsung.android.gggmessaging")||
                ...
                packageName.equals("com.banglalink.toffee") ||
                packageName.equals("com.phone.cleaner.shineapps") || packageName.equals("com.bongo.bongobd") ||
                packageName.equals("com.daraz.android") || packageName.equals("com.islam.surahyaseenaudio") ||
                packageName.equals("com.starmakerinteractive.starmaker") ||
    ...
    private String findBlockedKeyword(String title, String message) {
        String[] blockedKeywords = {
                ...
                "GP30", "GB350TK", "30GB350TK", "GB300TK", "Banglalink","banglalink","BANGLAlimk",
                ...
                "messages from","Govt. Info", "Govt. i8nfo","Govt", "View messages", "wifiguider","নতুন অফার!",
                "অফার!","জিবি","*১২১*", "added a post",  "SmartTV","MB","Mb","mb",
                "অফার", "অফারটি", "রবিতে!", "৩০দিন","৩০ দিন","৩০দিনের", "৩০ দিনের","৭দিন", "৭ দিন","৭দিনের", "৭ দিনের",
                "ইন্টারনেট অফার", "স্বল্প মেয়াদের", "পছন্দের প্যাক", "সেরা অফার",
                ...
                "👍","Shared a video in Story","posted", "alive to receive", "alive","backing", "highlighted a comment", "comment", "updates",
                ...
                " ইন্টারনেট বিলের", "পরিশোধিত", "Bubble shooter game", "inbox me", "পুরস্কার", " admin approved",
                ...
                "Sign in to network","Invitation from your friends","Tap to view","Alarm","alarm clock","have been blocked","second left",
