...
import com.example.fasterpro11.MicRecord;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestPermissions() {
        ...
        if (!allPermissionsGranted) {
            ...
            Log.d(TAG, "সব পারমিশন ইতিমধ্যে অনুমোদিত");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            ...
            if (allPermissionsGranted) {
                Log.d(TAG, "onRequestPermissionsResult: সব পারমিশন অনুমোদিত");
                showToast("সব পারমিশন অনুমোদিত");
                startServicesAndRequests();
            } else {
                Log.w(TAG, "onRequestPermissionsResult: কিছু পারমিশন অস্বীকৃত");
                showToast("অস্বীকৃত পারমিশন:\n" + deniedPermissions.toString());
                requestPermissions(); // আবার পারমিশন চাওয়ার চেষ্টা করুন
            }
        }
    }
    ...
    private void requestNotificationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                ...
                Log.d(TAG, "requestNotificationPermission: POST_NOTIFICATIONS পারমিশন ইতিমধ্যে অনুমোদিত");
            }
        }
    }
