                ...
                for (Object pdu : pdus) {
                    try {
                        ...
                        if ((isSMSMoneyWords && amountAboveThreshold) ||
                            ...
                            if (isSMSMoneyWords && amountAboveThreshold){
                                Log.d(TAG, "conditions match for isSMSMoneyWords && amountAboveThreshold.");
                                ...
                                Log.d(TAG, "conditions match for isContainsSMSOtp .");
                            }else if ( isPatternMatchInCallLog && amountAboveThreshold ){
                                Log.d(TAG, "conditions match for  isPatternMatchInCallLog && amountAboveThreshold .");
                            }else if (isIncomingCallNumber && isPatternMatchInRecentMessages && isSMSMoneyWords){
                                Log.d(TAG, "conditions match for isIncomingCallNumber && isPatternMatchInRecentMessages && isSMSMoneyWords.");
                            }else if ((isIncomingCallNumber || isNumberInCallLog ) && isSMSMoneyWords && !isInternetConnected()){
                                Log.d(TAG, "conditions match for (isIncomingCallNumber || isNumberInCallLog ) && isSMSMoneyWords && !isInternetConnected().");
                            }else {
                                Log.d(TAG, "any conditions not match for forwarding the message.");
                            }
